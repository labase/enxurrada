...
sys.path.append(SRC)
from enxurrada import __version__
...
def post_docs(project, logger):
    ...
    result = call(['curl', '-X', 'POST', 'http://readthedocs.org/build/enxurrada'])
    logger.info("Commit hook @ http://readthedocs.org/build/enxurrada: %d" % result)
